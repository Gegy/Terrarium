...
public interface RasterMapFeature<R extends Raster> extends MapFeature {
    ...
    @Override
    default CompletableFuture<Optional<BufferedImage>> render(final EarthLayers layers, final int zoomLevel, final int x0, final int y0, final int x1, final int y1) {

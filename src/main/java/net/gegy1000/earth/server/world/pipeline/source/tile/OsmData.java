...
public class OsmData implements OsmEntityProvider, MergableData<OsmData> {
    ...
    public OsmData(Long2ObjectMap<OsmNode> nodes, Long2ObjectMap<OsmWay> ways, Long2ObjectMap<OsmRelation> relations) {
        this.nodes = nodes;
        this.ways = ways;
    ...
    public static OsmData fromDataSet(InMemoryMapDataSet dataSet) {
        return new OsmData(dataSet.getNodes(), dataSet.getWays(), dataSet.getRelations());
    }
    ...
    @Override
    public OsmData merge(OsmData tile) {

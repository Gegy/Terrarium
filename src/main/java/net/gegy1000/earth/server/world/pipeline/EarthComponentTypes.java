...
public class EarthComponentTypes {
    public static final RegionComponentType<OsmTile> OSM = new RegionComponentType<OsmTile>(new Identifier(TerrariumEarth.MODID, "osm"), OsmTile.class) {
        @Override
    ...
    public static final RegionComponentType<WaterRasterTile> WATER = new RegionComponentType<WaterRasterTile>(new Identifier(TerrariumEarth.MODID, "water"), WaterRasterTile.class) {
        @Override

...
public class EarthDecorationComposer implements DecorationComposer {
    ...
    private final ObjRaster.Sampler<Cover> coverSampler;

    public EarthDecorationComposer(World world, DataKey<ObjRaster<Cover>> coverKey) {
        ...
        this.coverSampler = ObjRaster.sampler(coverKey);
    }

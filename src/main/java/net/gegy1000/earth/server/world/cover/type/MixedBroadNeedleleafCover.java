...
public class MixedBroadNeedleleafCover extends ForestCover {
    ...
    private static class Decoration extends ForestCover.Decoration {
        ...
        public void decorate(CubicPos chunkPos, ChunkPopulationWriter writer, Random random) {
            ...
            this.decorateScatter(random, chunkPos, writer, this.getOakCount(random, zone), (pos, localX, localZ) -> {
                if (clearingLayer[localX + localZ * 16] == 0) {
            ...
            this.decorateScatter(random, chunkPos, writer, this.getJungleCount(random, zone), (pos, localX, localZ) -> {

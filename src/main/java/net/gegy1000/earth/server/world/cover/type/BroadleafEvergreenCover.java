...
public class BroadleafEvergreenCover extends ForestCover {
    ...
    private static class Decoration extends ForestCover.Decoration {
        ...
        public void decorate(PopulateChunk chunk, BlockPos origin, Random random) {
            ...
            this.decorateScatter(random, chunk, origin, oakCount + 2, (pos, localX, localZ) -> OAK_DENSE_SHRUB.generate(world, random, pos));
            this.decorateScatter(random, chunk, origin, jungleCount + 2, (pos, localX, localZ) -> JUNGLE_DENSE_SHRUB.generate(world, random, pos));
        }

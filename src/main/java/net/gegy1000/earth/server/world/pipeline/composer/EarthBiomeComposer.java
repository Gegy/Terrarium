...
public final class EarthBiomeComposer implements BiomeComposer {
    ...
    public Biome[] composeBiomes(RegionGenerationHandler regionHandler, int chunkX, int chunkZ) {
        FloatRaster temperatureRaster = regionHandler.getCachedChunkRaster(this.temperatureComponent);
        ShortRaster rainfallRaster = regionHandler.getCachedChunkRaster(this.rainfallComponent);

...
public abstract class ListWidget extends GuiListExtended {
    public ListWidget(Minecraft client, int screenWidth, int screenHeight, int x, int y, int width, int height, int slotHeight) {

...
public class VegetationWithCroplandCover extends CoverGenerator {
    ...
    public VegetationWithCroplandCover() {
        super(CoverType.VEGETATION_WITH_CROPLAND);
    }
    ...
    public void decorate(Random random, LatitudinalZone zone, int x, int z) {
        ...
        this.decorateScatterSample(random, x, z, this.range(random, 1, 3), point -> {

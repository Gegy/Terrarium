...
public class IrrigatedCrops extends GlobGenerator {
    ...
    protected void createLayers() {
        GenLayer layer = new SelectionSeedLayer(IrrigatedCrops.CROP_COUNT, 1);
        layer = new GenLayerVoronoiZoom(1000, layer);
        layer = new GenLayerFuzzyZoom(2000, layer);
        layer = new GenLayerVoronoiZoom(3000, layer);
        layer = new OutlineEdgeLayer(IrrigatedCrops.LAYER_FENCE, 4000, layer);
        layer = new ConnectHorizontalLayer(IrrigatedCrops.LAYER_FENCE, 5000, layer);
    ...
    public void coverDecorate(GlobPrimer primer, Random random, int x, int z) {
        ...
        this.iterate(point -> {
            ...
            IBlockState state = IrrigatedCrops.getCropState(cropLayer[point.index]);
            ...
            if (state.getBlock() instanceof BlockCrops) {
                ...
                primer.setBlockState(point.localX, y, point.localZ, IrrigatedCrops.COARSE_DIRT);

package net.gegy1000.terrarium.server.world.pipeline.source.earth.osm;
...
public class OsmDataParser {
    ...
    public static OsmTileAccess parse(InputStream input) throws IOException {
        InMemoryMapDataSet entities = OsmDataParser.parseEntities(input);
        return new OsmTileAccess(entities);
    }
